...
class Lexico:
    ...
    def ungetchar(self, simbolo):
        ...
        # Ou faz uma lista de devolvidos
    ...
    def getToken(self):
        ...
        while (True):
            if estado == 1: # Decide o tipo de Token
                ...
                else:  # Passa o lexema '!' e o próximo símbolo para consumir
                    return self._consumirErro(lexema, simbolo, lin, col)
                ...
                if simbolo.isdigit():
                    ...
                    # REQ 2: O caractere após o ponto não é um dígito.
                    # Tratar o '.' como um token de ponto separado.
                    if simbolo != '\0':
                        self.ungetchar(simbolo)  # Devolve o caractere lido após o ponto
